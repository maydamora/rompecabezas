...
var AgregarUltimoMovimiento = function(mov) {
  movimientos.push(mov);
  actualizarUltimoMovimiento(mov);
};
...
function mostrarCartelGanador() {
  Swal.fire({
    ...
    imageUrl: 'http://giphygifs.s3.amazonaws.com/media/czvoPCnFyjh6w/giphy.gif',
    imageWidth: 400,
    imageHeight: 200,
    imageAlt: 'BMO Dancing',
  })
}
...
codigosDireccion.IZQUIERDA9. Esto facilita mucho la lectura del código. */
